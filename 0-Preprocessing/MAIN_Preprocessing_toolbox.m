...
for i = 1:size(Trial,2)    
    ...
    if emg == 1
        ...
        if contains(Trial(i).file,'Pointing') % No EMG filtering for pointing_SXS used as reference EMG file
            Processing2 = Processing;
            Processing2.EMG.zmethod.type = 'none';
            Processing2.EMG.fmethod.type = 'none';
            Processing2.EMG.smethod.type = 'none';
            Trial(i) = ProcessEMGSignals(Trial(i),Processing2);
        else
