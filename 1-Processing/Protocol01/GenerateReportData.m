...
for itrial = 1:size(Trial,2)
    if strcmp(Trial(itrial).task,'ANALYTIC1')      
        ...
        Report.Analytic(1).Kinematics.SHR(1).theta_HT1  = permute(Trial(itrial).SHR(1).theta_HT(1).cycle,[3,1,4,2]);
        Report.Analytic(1).Kinematics.SHR(1).theta_ST1  = permute(Trial(itrial).SHR(1).theta_ST(1).cycle,[3,1,4,2]);
        Report.Analytic(1).Kinematics.SHR(1).theta_GH1  = permute(Trial(itrial).SHR(1).theta_GH(1).cycle,[3,1,4,2]);
        Report.Analytic(1).Kinematics.SHR(1).SHR_curve1 = permute(Trial(itrial).SHR(1).SHR_curve(1).cycle,[3,1,4,2]);
        Report.Analytic(1).Kinematics.SHR(1).SHR_mean1  = permute(Trial(itrial).SHR(1).SHR_mean(1).cycle,[3,1,4,2]);
        Report.Analytic(1).Kinematics.SHR(1).theta_HT2  = permute(Trial(itrial).SHR(1).theta_HT(2).cycle,[3,1,4,2]);
        Report.Analytic(1).Kinematics.SHR(1).theta_ST2  = permute(Trial(itrial).SHR(1).theta_ST(2).cycle,[3,1,4,2]);
        Report.Analytic(1).Kinematics.SHR(1).theta_GH2  = permute(Trial(itrial).SHR(1).theta_GH(2).cycle,[3,1,4,2]);
        Report.Analytic(1).Kinematics.SHR(1).SHR_curve2 = permute(Trial(itrial).SHR(1).SHR_curve(2).cycle,[3,1,4,2]);
        Report.Analytic(1).Kinematics.SHR(1).SHR_mean2  = permute(Trial(itrial).SHR(1).SHR_mean(2).cycle,[3,1,4,2]);
        ...
        Report.Analytic(1).Kinematics.SHR(2).theta_HT1  = permute(Trial(itrial).SHR(2).theta_HT(1).cycle,[3,1,4,2]);
        Report.Analytic(1).Kinematics.SHR(2).theta_ST1  = permute(Trial(itrial).SHR(2).theta_ST(1).cycle,[3,1,4,2]);
        Report.Analytic(1).Kinematics.SHR(2).theta_GH1  = permute(Trial(itrial).SHR(2).theta_GH(1).cycle,[3,1,4,2]);
        Report.Analytic(1).Kinematics.SHR(2).SHR_curve1 = permute(Trial(itrial).SHR(2).SHR_curve(1).cycle,[3,1,4,2]);
        Report.Analytic(1).Kinematics.SHR(2).SHR_mean1  = permute(Trial(itrial).SHR(2).SHR_mean(1).cycle,[3,1,4,2]);
        Report.Analytic(1).Kinematics.SHR(2).theta_HT2  = permute(Trial(itrial).SHR(2).theta_HT(2).cycle,[3,1,4,2]);
        Report.Analytic(1).Kinematics.SHR(2).theta_ST2  = permute(Trial(itrial).SHR(2).theta_ST(2).cycle,[3,1,4,2]);
        Report.Analytic(1).Kinematics.SHR(2).theta_GH2  = permute(Trial(itrial).SHR(2).theta_GH(2).cycle,[3,1,4,2]);
        Report.Analytic(1).Kinematics.SHR(2).SHR_curve2 = permute(Trial(itrial).SHR(2).SHR_curve(2).cycle,[3,1,4,2]);
        Report.Analytic(1).Kinematics.SHR(2).SHR_mean2  = permute(Trial(itrial).SHR(2).SHR_mean(2).cycle,[3,1,4,2]);
        % --        
        for iemg                                         = 1:7
...
%             if ~isempty(Trial(itrial).Emg(iemg).Signal.cycle)
            if length(find(isnan(Trial(itrial).Emg(iemg).Signal.cycle2))) < length(Trial(itrial).Emg(iemg).Signal.cycle2)
                Report.Analytic(1).Emg.Envelop(iemg).value = permute(Trial(itrial).Emg(iemg).Signal.cycle2,[3,1,4,2]); % Onset
            else
...
%             if ~isempty(Trial(itrial).Emg(iemg).Signal.cycle)
    ...
    elseif strcmp(Trial(itrial).task,'ANALYTIC2')
        ...
        Report.Analytic(2).Kinematics.SHR(1).theta_HT1  = permute(Trial(itrial).SHR(1).theta_HT(1).cycle,[3,1,4,2]);
        Report.Analytic(2).Kinematics.SHR(1).theta_ST1  = permute(Trial(itrial).SHR(1).theta_ST(1).cycle,[3,1,4,2]);
        Report.Analytic(2).Kinematics.SHR(1).theta_GH1  = permute(Trial(itrial).SHR(1).theta_GH(1).cycle,[3,1,4,2]);
        Report.Analytic(2).Kinematics.SHR(1).SHR_curve1 = permute(Trial(itrial).SHR(1).SHR_curve(1).cycle,[3,1,4,2]);
        Report.Analytic(2).Kinematics.SHR(1).SHR_mean1  = permute(Trial(itrial).SHR(1).SHR_mean(1).cycle,[3,1,4,2]);
        Report.Analytic(2).Kinematics.SHR(1).theta_HT2  = permute(Trial(itrial).SHR(1).theta_HT(2).cycle,[3,1,4,2]);
        Report.Analytic(2).Kinematics.SHR(1).theta_ST2  = permute(Trial(itrial).SHR(1).theta_ST(2).cycle,[3,1,4,2]);
        Report.Analytic(2).Kinematics.SHR(1).theta_GH2  = permute(Trial(itrial).SHR(1).theta_GH(2).cycle,[3,1,4,2]);
        Report.Analytic(2).Kinematics.SHR(1).SHR_curve2 = permute(Trial(itrial).SHR(1).SHR_curve(2).cycle,[3,1,4,2]);
        Report.Analytic(2).Kinematics.SHR(1).SHR_mean2  = permute(Trial(itrial).SHR(1).SHR_mean(2).cycle,[3,1,4,2]);
        ...
        Report.Analytic(2).Kinematics.SHR(2).theta_HT1  = permute(Trial(itrial).SHR(2).theta_HT(1).cycle,[3,1,4,2]);
        Report.Analytic(2).Kinematics.SHR(2).theta_ST1  = permute(Trial(itrial).SHR(2).theta_ST(1).cycle,[3,1,4,2]);
        Report.Analytic(2).Kinematics.SHR(2).theta_GH1  = permute(Trial(itrial).SHR(2).theta_GH(1).cycle,[3,1,4,2]);
        Report.Analytic(2).Kinematics.SHR(2).SHR_curve1 = permute(Trial(itrial).SHR(2).SHR_curve(1).cycle,[3,1,4,2]);
        Report.Analytic(2).Kinematics.SHR(2).SHR_mean1  = permute(Trial(itrial).SHR(2).SHR_mean(1).cycle,[3,1,4,2]);
        Report.Analytic(2).Kinematics.SHR(2).theta_HT2  = permute(Trial(itrial).SHR(2).theta_HT(2).cycle,[3,1,4,2]);
        Report.Analytic(2).Kinematics.SHR(2).theta_ST2  = permute(Trial(itrial).SHR(2).theta_ST(2).cycle,[3,1,4,2]);
        Report.Analytic(2).Kinematics.SHR(2).theta_GH2  = permute(Trial(itrial).SHR(2).theta_GH(2).cycle,[3,1,4,2]);
        Report.Analytic(2).Kinematics.SHR(2).SHR_curve2 = permute(Trial(itrial).SHR(2).SHR_curve(2).cycle,[3,1,4,2]);
        Report.Analytic(2).Kinematics.SHR(2).SHR_mean2  = permute(Trial(itrial).SHR(2).SHR_mean(2).cycle,[3,1,4,2]);
        % --        
        for iemg = 1:7
...
%             if ~isempty(Trial(itrial).Emg(iemg).Signal.cycle)
            if length(find(isnan(Trial(itrial).Emg(iemg).Signal.cycle2))) < length(Trial(itrial).Emg(iemg).Signal.cycle2)
                Report.Analytic(2).Emg.Envelop(iemg).value = permute(Trial(itrial).Emg(iemg).Signal.cycle2,[3,1,4,2]); % Onset
            else
...
%             if ~isempty(Trial(itrial).Emg(iemg).Signal.cycle)
            if length(find(isnan(Trial(itrial).Emg(iemg).Signal.cycle2))) < length(Trial(itrial).Emg(iemg).Signal.cycle2)
                Report.Analytic(3).Emg.Envelop(iemg).value = permute(Trial(itrial).Emg(iemg).Signal.cycle2,[3,1,4,2]); % Onset
            else
...
%             if ~isempty(Trial(itrial).Emg(iemg).Signal.cycle)
            if length(find(isnan(Trial(itrial).Emg(iemg).Signal.cycle2))) < length(Trial(itrial).Emg(iemg).Signal.cycle2)
                Report.Analytic(4).Emg.Envelop(iemg).value = permute(Trial(itrial).Emg(iemg).Signal.cycle2,[3,1,4,2]); % Onset
            else
