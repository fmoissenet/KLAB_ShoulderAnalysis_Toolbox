...
for itrial = 1:size(Trial,2)
    if strcmp(Trial(itrial).task,'ANALYTIC1')      
        ...
        Report.Analytic(1).Kinematics.SHR(1).theta_HT         = permute(Trial(itrial).SHR(1).theta_HT.cycle,[3,1,4,2]);
        ...
        Report.Analytic(1).Kinematics.SHR(2).theta_HT         = permute(Trial(itrial).SHR(2).theta_HT.cycle,[3,1,4,2]);
...
%             if ~isempty(Trial(itrial).Emg(iemg).Signal.cycle)
    ...
    elseif strcmp(Trial(itrial).task,'ANALYTIC2')
        ...
        Report.Analytic(2).Kinematics.SHR(1).theta_HT    = permute(Trial(itrial).SHR(1).theta_HT.cycle,[3,1,4,2]);
        ...
        Report.Analytic(2).Kinematics.SHR(2).theta_HT    = permute(Trial(itrial).SHR(2).theta_HT.cycle,[3,1,4,2]);
